class AliasDirectory < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/alias-directory-v1.0.0/bin/alias-directory"
  ...
  test do
    assert_match "alias-directory 1.0.0", shell_output("#{bin}/alias-directory --version")
  end
end
