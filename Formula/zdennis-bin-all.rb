class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.25.0/bin/zdennis-bin-all"
  sha256 "77f8029a845bd76c7ae87e739e8e2b2930c1da8e781a656f4ba03d889df0e1fa"
  license "MIT"
