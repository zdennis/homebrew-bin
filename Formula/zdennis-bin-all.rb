class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.7.1/bin/zdennis-bin-all"
  sha256 "075cbaf498561552a56b301386c837db7f429b5d4569da37be4fb7b7a55d3aa6"
  license "MIT"
