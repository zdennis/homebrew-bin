class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.29.0/bin/zdennis-bin-all"
  sha256 "ed9a5ca02b4217051fa38ec0734061528ea3ed61f3aa2df8cad2acc7c893934a"
  license "MIT"
