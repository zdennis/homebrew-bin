class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.25.1/bin/zdennis-bin-all"
  sha256 "a9227206fe372548a94dd06ad3fe57e486b8eaa174c65bbb4c6c64f472bd9acb"
  license "MIT"
