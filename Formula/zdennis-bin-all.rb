class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.27.2/bin/zdennis-bin-all"
  sha256 "bdf2a69ae0f7fc368849418316a8577320b367456f5d10ce60baf412fe1d724a"
  license "MIT"
