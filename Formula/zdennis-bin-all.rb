class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.8.6/bin/zdennis-bin-all"
  sha256 "5a26bff8afb7de2b372b07642007973cd0e4c858712b2487f6e9868175ba4065"
  license "MIT"
