class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.8.2/bin/zdennis-bin-all"
  sha256 "83deffbf9d466e5993ac0ed997ae53d7abb70139429c9fd0d9fb10940f8ae9db"
  license "MIT"
