class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.8.5/bin/zdennis-bin-all"
  sha256 "79f2b768a1d8dd6c74d407cd8df902a0c19da590abe1fe8353d851ccb8c02b53"
  license "MIT"
