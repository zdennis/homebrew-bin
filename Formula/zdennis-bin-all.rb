class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.8.3/bin/zdennis-bin-all"
  sha256 "dacfb7cd2db35a1bdfc505b2dd565da1782bf5ac8823a9c93b4816b165121d14"
  license "MIT"
