class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.29.7/bin/zdennis-bin-all"
  sha256 "130aba6a54a45854fadffcc82631135b935d7daaa2c5849e066a56b6917ef1a2"
  license "MIT"
