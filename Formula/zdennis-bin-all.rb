class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.22.1/bin/zdennis-bin-all"
  sha256 "ef7b5b14f977fb1786278f81dfd3c047e5f2c30ce2fbd39dfe155e5edf6ef7dc"
  license "MIT"
