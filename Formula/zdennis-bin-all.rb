class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.29.2/bin/zdennis-bin-all"
  sha256 "4ea008f82b7c89fc6dac8e6c6129eb70ab6210ed64addc0d95aafd88b20308a7"
  license "MIT"
