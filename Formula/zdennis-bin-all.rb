class ZdennisBinAll < Formula
  ...
  url "https://raw.githubusercontent.com/zdennis/bin/zdennis-bin-all-v1.21.1/bin/zdennis-bin-all"
  sha256 "7f4edbd0998594be61b3edb917420074b5ee67968309b3db2d9987d6e23253dc"
  license "MIT"
